...
namespace Einvoicing.Infrastructure.Migrations
{
    ...
    [Migration("20260508202501_AddExpenseReviewAndSuppliers")]
    partial class AddExpenseReviewAndSuppliers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Einvoicing.Domain.Entities.DemoRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Einvoicing.Domain.Entities.Entreprise", b =>
                {
                    ...
                    b.Property<string>("DocumentsUploades")
                        .HasColumnType("text");

                    b.Property<string>("DonneesInscription")
                        .HasColumnType("text");

                    b.Property<string>("DonneesScoring")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Einvoicing.Domain.Entities.Personnalisation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Personnalisations", (string)null);
                });
            ...
            modelBuilder.Entity("Einvoicing.Domain.Entities.ScannedDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Einvoicing.Domain.Entities.Taxe", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Einvoicing.Domain.Entities.Transaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("JustificatifNomFichier")
                        .HasMaxLength(260)
                        .HasColumnType("character varying(260)");

                    b.Property<long?>("JustificatifTailleOctets")
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("StatutJustificatif")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");

                    b.Property<string>("TiersNom")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
